# CLAUDE.md — Mimir workspace guide
...
`AGENTS.md`, `STATUS.md`, and the relevant concept docs.
...
and spec evidence governance. Treat Claude memory as evidence only; Mimir's
librarian path remains the product boundary for durable shared memory.
